...
overlap_interaction <- intersect(interaction_genes, overlap_fungenomic)
```
...
#overlap interaction genes
for (gene in 1:length(overlap_interaction)) {
     print(plot_gene(v2, as.character(overlap_interaction[gene])))
}
