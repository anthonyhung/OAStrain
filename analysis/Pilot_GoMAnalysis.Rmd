...
Combined.common.allGenes <- merge(ANT1.2, y = c(chondro.seurat, gh_big_humans, liver), project = "Combined.common")
Combined.common.allGenes_noliver <- merge(ANT1.2, y = c(chondro.seurat, gh_big_humans), project = "Combined.common.noliver")
