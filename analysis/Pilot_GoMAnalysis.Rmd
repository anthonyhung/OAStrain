...
VlnPlot(object=chondro.seurat, features = c("SOX9", "ACAN", "COL2A1"))

#Pilot data
ANT1.2 <- readRDS("data/ANT1_2.rds")
ANT1.2 <- AddMetaData(ANT1.2, "iPSC-Chondrocyte", col.name = "Cell.Type")
dim(ANT1.2)
VlnPlot(object=ANT1.2, features = c("SOX9", "ACAN", "COL2A1"))
```
...
FeaturePlot(object = Combined.common, feature = "SOX9")
```
