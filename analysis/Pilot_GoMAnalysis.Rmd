...
gh_chondro <- Seurat::AddMetaData(gh_chondro, "iPSC-Chond-GAH", col.name = "Cell.Type")
gh_big <- merge(gh_ipsc_1.1, y = c(gh_msc_1.1, gh_chondro), 
                add.cell.ids = c("ipsc1.1", "msc1.1", "chondro_gh"), project = "ghousman")
...
common.features <- Reduce(intersect, list(rownames(ANT1.2), rownames(chondro.seurat), rownames(Chond_seurat), rownames(gh_big_humans), rownames(liver)))
length(x = common.features)
Combined.common <- merge(ANT1.2[common.features, ], y = c(chondro.seurat[common.features, ], Chond_seurat[common.features, ], gh_big_humans[common.features, ], liver[common.features, ]), project = "Combined.common")

#merge keeping all genes
Combined.common.allGenes <- merge(ANT1.2, y = c(chondro.seurat, Chond_seurat, gh_big_humans, liver), project = "Combined.common")
Combined.common.allGenes_noliver <- merge(ANT1.2, y = c(chondro.seurat, Chond_seurat, gh_big_humans), project = "Combined.common.noliver")
...
# saveRDS(fitall_2, "output/fasttopics/fasttopics_k=2_nmf.rds")
# 
...
# saveRDS(fitall_3, "output/fasttopics/fasttopics_k=3_nmf.rds")
# 
...
# saveRDS(fitall_4, "output/fasttopics/fasttopics_k=4_nmf.rds")
# 
...
# saveRDS(fitall_5, "output/fasttopics/fasttopics_k=5_nmf.rds")
# 
...
# saveRDS(fitall_6, "output/fasttopics/fasttopics_k=6_nmf.rds")
# 
...
# saveRDS(fitall_7, "output/fasttopics/fasttopics_k=7_nmf.rds")
# 
...
# saveRDS(fitall_8, "output/fasttopics/fasttopics_k=8_nmf.rds")

fitall_2 <- readRDS("output/fasttopics/fasttopics_k=2_nmf.rds")
fitall_3 <- readRDS("output/fasttopics/fasttopics_k=3_nmf.rds")
fitall_4 <- readRDS("output/fasttopics/fasttopics_k=4_nmf.rds")
fitall_5 <- readRDS("output/fasttopics/fasttopics_k=5_nmf.rds")
fitall_6 <- readRDS("output/fasttopics/fasttopics_k=6_nmf.rds")
fitall_7 <- readRDS("output/fasttopics/fasttopics_k=7_nmf.rds")
fitall_8 <- readRDS("output/fasttopics/fasttopics_k=8_nmf.rds")
...
plot_UMAP_GoM <- function(seurat.obj, fit){
     k <- ncol(fit$L)
     seurat.obj@meta.data <- cbind(seurat.obj@meta.data, fit$L)
     for(topic in 1:k){
          plot(FeaturePlot(seurat.obj, paste0("k", topic)))
          plot(VlnPlot(seurat.obj, features = paste0("k", topic), ncol = 1, group.by = "labels")
)
     }
}
...
#only keep genes with non zero counts in each of the three individuals
gene_overlap <- intersect(intersect(colnames(NA18855_unstrain_only), colnames(NA18856_unstrain_only)), colnames(NA19160_unstrain_only))
NA18855_unstrain_only <- NA18855_unstrain_only[,gene_overlap]
NA18856_unstrain_only <- NA18856_unstrain_only[,gene_overlap]
NA19160_unstrain_only <- NA19160_unstrain_only[,gene_overlap]
counts_gene_overlap <- counts[,gene_overlap]
...
# saveRDS(fit18855_2, "output/fasttopics/fasttopics_NA18855_only_k=2_nmf.rds")
...
# saveRDS(fit18855_3, "output/fasttopics/fasttopics_NA18855_only_k=3_nmf.rds")
...
# saveRDS(fit18855_4, "output/fasttopics/fasttopics_NA18855_only_k=4_nmf.rds")
# 
...
# saveRDS(fit18856_2, "output/fasttopics/fasttopics_NA18856_only_k=2_nmf.rds")
...
# saveRDS(fit18856_3, "output/fasttopics/fasttopics_NA18856_only_k=3_nmf.rds")
...
# saveRDS(fit18856_4, "output/fasttopics/fasttopics_NA18856_only_k=4_nmf.rds")
# 
# #
...
# saveRDS(fit19160_2, "output/fasttopics/fasttopics_NA19160_only_k=2_nmf.rds")
...
# saveRDS(fit19160_3, "output/fasttopics/fasttopics_NA19160_only_k=3_nmf.rds")
...
# saveRDS(fit19160_4, "output/fasttopics/fasttopics_NA19160_only_k=4_nmf.rds")


fit18855_2 <- readRDS("output/fasttopics/fasttopics_NA18855_only_k=2_nmf.rds")
fit18855_3 <- readRDS("output/fasttopics/fasttopics_NA18855_only_k=3_nmf.rds")
fit18855_4 <- readRDS("output/fasttopics/fasttopics_NA18855_only_k=4_nmf.rds")
fit18856_2 <- readRDS("output/fasttopics/fasttopics_NA18856_only_k=2_nmf.rds")
fit18856_3 <- readRDS("output/fasttopics/fasttopics_NA18856_only_k=3_nmf.rds")
fit18856_4 <- readRDS("output/fasttopics/fasttopics_NA18856_only_k=4_nmf.rds")
fit19160_2 <- readRDS("output/fasttopics/fasttopics_NA19160_only_k=2_nmf.rds")
fit19160_3 <- readRDS("output/fasttopics/fasttopics_NA19160_only_k=3_nmf.rds")
fit19160_4 <- readRDS("output/fasttopics/fasttopics_NA19160_only_k=4_nmf.rds")

fit18855.multinom_2 <- readRDS("output/fasttopics/fasttopics_NA18855_only_k=2.rds")
fit18855.multinom_3 <- readRDS("output/fasttopics/fasttopics_NA18855_only_k=3.rds")
fit18855.multinom_4 <- readRDS("output/fasttopics/fasttopics_NA18855_only_k=4.rds")
fit18856.multinom_2 <- readRDS("output/fasttopics/fasttopics_NA18856_only_k=2.rds")
fit18856.multinom_3 <- readRDS("output/fasttopics/fasttopics_NA18856_only_k=3.rds")
fit18856.multinom_4 <- readRDS("output/fasttopics/fasttopics_NA18856_only_k=4.rds")
fit19160.multinom_2 <- readRDS("output/fasttopics/fasttopics_NA19160_only_k=2.rds")
fit19160.multinom_3 <- readRDS("output/fasttopics/fasttopics_NA19160_only_k=3.rds")
fit19160.multinom_4 <- readRDS("output/fasttopics/fasttopics_NA19160_only_k=4.rds")
```

Now, use the models that have been fit to fit the remaining samples

```{r apply fit model to all samples}
# init.fit_18855_2 <- init_poisson_nmf(X = counts_gene_overlap,
#                  F = fit18855_2$F,
#                  init.method = "random")
# refit_18855_2 <- fit_poisson_nmf(X = counts_gene_overlap,
#                 fit0 = init.fit_18855_2,
#                 numiter = 200,
#                 update.factors = NULL)
# saveRDS(refit_18855_2, "output/fasttopics/fasttopics_NA18855_refit_k=2_nmf.rds")

# init.fit_18855_3 <- init_poisson_nmf(X = counts_gene_overlap,
#                  F = fit18855_3$F,
#                  init.method = "random")
# refit_18855_3 <- fit_poisson_nmf(X = counts_gene_overlap,
#                 fit0 = init.fit_18855_3,
#                 numiter = 200,
#                 update.factors = NULL)
# saveRDS(refit_18855_3, "output/fasttopics/fasttopics_NA18855_refit_k=3_nmf.rds")

# init.fit_18855_4 <- init_poisson_nmf(X = counts_gene_overlap,
#                  F = fit18855_4$F,
#                  init.method = "random")
# refit_18855_4 <- fit_poisson_nmf(X = counts_gene_overlap,
#                 fit0 = init.fit_18855_4,
#                 numiter = 200,
#                 update.factors = NULL)
# saveRDS(refit_18855_4, "output/fasttopics/fasttopics_NA18855_refit_k=4_nmf.rds")

# init.fit_18856_2 <- init_poisson_nmf(X = counts_gene_overlap,
#                  F = fit18856_2$F,
#                  init.method = "random")
# refit_18856_2 <- fit_poisson_nmf(X = counts_gene_overlap,
#                 fit0 = init.fit_18856_2,
#                 numiter = 200,
#                 update.factors = NULL)
# saveRDS(refit_18856_2, "output/fasttopics/fasttopics_NA18856_refit_k=2_nmf.rds")
# 
# init.fit_18856_3 <- init_poisson_nmf(X = counts_gene_overlap,
#                  F = fit18856_3$F,
#                  init.method = "random")
# refit_18856_3 <- fit_poisson_nmf(X = counts_gene_overlap,
#                 fit0 = init.fit_18856_3,
#                 numiter = 200,
#                 update.factors = NULL)
# saveRDS(refit_18856_3, "output/fasttopics/fasttopics_NA18856_refit_k=3_nmf.rds")
# 
# init.fit_18856_4 <- init_poisson_nmf(X = counts_gene_overlap,
#                  F = fit18856_4$F,
#                  init.method = "random")
# refit_18856_4 <- fit_poisson_nmf(X = counts_gene_overlap,
#                 fit0 = init.fit_18856_4,
#                 numiter = 200,
#                 update.factors = NULL)
# saveRDS(refit_18856_4, "output/fasttopics/fasttopics_NA18856_refit_k=4_nmf.rds")
# 
# 
# init.fit_19160_2 <- init_poisson_nmf(X = counts_gene_overlap,
#                  F = fit19160_2$F,
#                  init.method = "random")
# refit_19160_2 <- fit_poisson_nmf(X = counts_gene_overlap,
#                 fit0 = init.fit_19160_2,
#                 numiter = 200,
#                 update.factors = NULL)
# saveRDS(refit_19160_2, "output/fasttopics/fasttopics_NA19160_refit_k=2_nmf.rds")
# 
# init.fit_19160_3 <- init_poisson_nmf(X = counts_gene_overlap,
#                  F = fit19160_3$F,
#                  init.method = "random")
# refit_19160_3 <- fit_poisson_nmf(X = counts_gene_overlap,
#                 fit0 = init.fit_19160_3,
#                 numiter = 200,
#                 update.factors = NULL)
# saveRDS(refit_19160_3, "output/fasttopics/fasttopics_NA19160_refit_k=3_nmf.rds")
# 
# init.fit_19160_4 <- init_poisson_nmf(X = counts_gene_overlap,
#                  F = fit19160_4$F,
#                  init.method = "random")
# refit_19160_4 <- fit_poisson_nmf(X = counts_gene_overlap,
#                 fit0 = init.fit_19160_4,
#                 numiter = 200,
#                 update.factors = NULL)
# saveRDS(refit_19160_4, "output/fasttopics/fasttopics_NA19160_refit_k=4_nmf.rds")

refit_18855_2 <- readRDS("output/fasttopics/fasttopics_NA18855_refit_k=2_nmf.rds")
refit_18855_3 <- readRDS("output/fasttopics/fasttopics_NA18855_refit_k=3_nmf.rds")
refit_18855_4 <- readRDS("output/fasttopics/fasttopics_NA18855_refit_k=4_nmf.rds")
refit_18856_2 <- readRDS("output/fasttopics/fasttopics_NA18856_refit_k=2_nmf.rds")
refit_18856_3 <- readRDS("output/fasttopics/fasttopics_NA18856_refit_k=3_nmf.rds")
refit_18856_4 <- readRDS("output/fasttopics/fasttopics_NA18856_refit_k=4_nmf.rds")
refit_19160_2 <- readRDS("output/fasttopics/fasttopics_NA19160_refit_k=2_nmf.rds")
refit_19160_3 <- readRDS("output/fasttopics/fasttopics_NA19160_refit_k=3_nmf.rds")
refit_19160_4 <- readRDS("output/fasttopics/fasttopics_NA19160_refit_k=4_nmf.rds")
```

Visualize

```{r viz_refit semisupervised}
plot_UMAP_GoM_adjust <- function(seurat.obj, fit){
     k <- ncol(fit$L)
     L <- fit$L
     rowsums <- rowSums(L)
     L_adjusted <- L
     for(column in 1:k){
          L_adjusted[,column] <- L_adjusted[,column]/rowsums # make it so the membership in each topic adds up to a total of 1
     }

     seurat.obj@meta.data <- cbind(seurat.obj@meta.data, L_adjusted)
     for(topic in 1:k){
          plot(FeaturePlot(seurat.obj, paste0("k", topic)))
          plot(VlnPlot(seurat.obj, features = paste0("k", topic), ncol = 1, group.by = "labels")
)
...
#visualize
for(fit in list(refit_18855_2, refit_18855_3, refit_18855_4, refit_18856_2, refit_18856_3, refit_18856_4, refit_19160_2, refit_19160_3, refit_19160_4)){
     print(ncol(fit$L))
     plot(DimPlot(SCT_integrated, reduction = "umap", group.by = "labels"))
     plot(DimPlot(SCT_integrated, reduction = "umap", group.by = "seurat_clusters"))
     plot_UMAP_GoM_adjust(SCT_integrated, fit)
}
```
