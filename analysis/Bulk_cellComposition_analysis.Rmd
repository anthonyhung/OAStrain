...
Combined_GoM <- runfitGoM(t(filtered_counts), start = 3, end = 8)
```
...
# k = 3
plot_structure_plot(omega = Combined_GoM[[1]]$clust_3$omega, labels = labels)
make_topic_plots(omega = Combined_GoM[[1]]$clust_3$omega, labels = labels)
genes <- annotate_clusters(theta_mat = Combined_GoM[[1]]$clust_3$theta, countmatrix = filtered_counts)
matrix(gene_anno$external_gene_name[match(genes[[1]], gene_anno$ensembl_gene_id)], ncol = 100)
genes[[2]]

# k = 4
plot_structure_plot(omega = Combined_GoM[[2]]$clust_4$omega, labels = labels)
make_topic_plots(omega = Combined_GoM[[2]]$clust_4$omega, labels = labels)
genes <- annotate_clusters(theta_mat = Combined_GoM[[2]]$clust_4$theta, countmatrix = filtered_counts)
matrix(gene_anno$external_gene_name[match(genes[[1]], gene_anno$ensembl_gene_id)], ncol = 100)
genes[[2]]

# k = 5
plot_structure_plot(omega = Combined_GoM[[3]]$clust_5$omega, labels = labels)
make_topic_plots(omega = Combined_GoM[[3]]$clust_5$omega, labels = labels)
genes <- annotate_clusters(theta_mat = Combined_GoM[[3]]$clust_5$theta, countmatrix = filtered_counts)
matrix(gene_anno$external_gene_name[match(genes[[1]], gene_anno$ensembl_gene_id)], ncol = 100)
genes[[2]]

# k = 6
plot_structure_plot(omega = Combined_GoM[[4]]$clust_6$omega, labels = labels)
make_topic_plots(omega = Combined_GoM[[4]]$clust_6$omega, labels = labels)
genes <- annotate_clusters(theta_mat = Combined_GoM[[4]]$clust_6$theta, countmatrix = filtered_counts)
matrix(gene_anno$external_gene_name[match(genes[[1]], gene_anno$ensembl_gene_id)], ncol = 100)
genes[[2]]

# k = 7
plot_structure_plot(omega = Combined_GoM[[5]]$clust_7$omega, labels = labels)
make_topic_plots(omega = Combined_GoM[[5]]$clust_7$omega, labels = labels)
genes <- annotate_clusters(theta_mat = Combined_GoM[[5]]$clust_7$theta, countmatrix = filtered_counts)
matrix(gene_anno$external_gene_name[match(genes[[1]], gene_anno$ensembl_gene_id)], ncol = 100)
genes[[2]]

# k = 8
plot_structure_plot(omega = Combined_GoM[[6]]$clust_8$omega, labels = labels)
make_topic_plots(omega = Combined_GoM[[6]]$clust_8$omega, labels = labels)
genes <- annotate_clusters(theta_mat = Combined_GoM[[6]]$clust_8$theta, countmatrix = filtered_counts)
matrix(gene_anno$external_gene_name[match(genes[[1]], gene_anno$ensembl_gene_id)], ncol = 100)
genes[[2]]
```
...
#SOX9
boxplot_gene_sample_type(filtered_upperquartile, labels, "ENSG00000125398", "SOX9")
#ACAN
boxplot_gene_sample_type(filtered_upperquartile, labels, "ENSG00000157766", "ACAN")
#COL11A1
boxplot_gene_sample_type(filtered_upperquartile, labels, "ENSG00000060718", "COL11A1")
#SOX5
boxplot_gene_sample_type(filtered_upperquartile, labels, "ENSG00000134532", "SOX5")
#SOX6
boxplot_gene_sample_type(filtered_upperquartile, labels, "ENSG00000110693", "SOX6")
#TGFB3
boxplot_gene_sample_type(filtered_upperquartile, labels, "ENSG00000119699", "TGFB3")
