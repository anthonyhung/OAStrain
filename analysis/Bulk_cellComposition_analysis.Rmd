...
# Perform topic modeling k=7
if (file.exists("data/merged_topic_fit_7_classtpx_omega_fix_allMSC_earlyChond.rda")){
     Topic_clus_7_allMSC_earlyChond <- get(load(file="data/merged_topic_fit_7_classtpx_omega_fix_allMSC_earlyChond.rda"))
} else {
Topic_clus_7_allMSC_earlyChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=7,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_7_allMSC_earlyChond, file="data/merged_topic_fit_7_classtpx_omega_fix_allMSC_earlyChond.rda")
}

omega <- Topic_clus_7_allMSC_earlyChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
CountClust::StructureGGplot(omega = omega,
                annotation = annotation,
                palette = RColorBrewer::brewer.pal(7, "Accent"),
                yaxis_label = "Tissue/Cell Type",
                order_sample = TRUE,
                axis_tick = list(axis_ticks_length = .1,
                                 axis_ticks_lwd_y = .1,
...
# Perform topic modeling k=8
if (file.exists("data/merged_topic_fit_8_classtpx_omega_fix_allMSC_earlyChond.rda")){
     Topic_clus_8_allMSC_earlyChond <- get(load(file="data/merged_topic_fit_8_classtpx_omega_fix_allMSC_earlyChond.rda"))
} else {
Topic_clus_8_allMSC_earlyChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=8,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_8_allMSC_earlyChond, file="data/merged_topic_fit_8_classtpx_omega_fix_allMSC_earlyChond.rda")
}

omega <- Topic_clus_8_allMSC_earlyChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Perform topic modeling k=7
if (file.exists("data/merged_topic_fit_7_classtpx_omega_fix_adMSC_earlyChond.rda")){
     Topic_clus_7_adMSC_earlyChond <- get(load(file="data/merged_topic_fit_7_classtpx_omega_fix_adMSC_earlyChond.rda"))
} else {
Topic_clus_7_adMSC_earlyChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=7,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_7_adMSC_earlyChond, file="data/merged_topic_fit_7_classtpx_omega_fix_adMSC_earlyChond.rda")
}

omega <- Topic_clus_7_adMSC_earlyChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Perform topic modeling k=8
if (file.exists("data/merged_topic_fit_8_classtpx_omega_fix_adMSC_earlyChond.rda")){
     Topic_clus_8_adMSC_earlyChond <- get(load(file="data/merged_topic_fit_8_classtpx_omega_fix_adMSC_earlyChond.rda"))
} else {
Topic_clus_8_adMSC_earlyChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=8,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_8_adMSC_earlyChond, file="data/merged_topic_fit_8_classtpx_omega_fix_adMSC_earlyChond.rda")
}

omega <- Topic_clus_8_adMSC_earlyChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Perform topic modeling k=7
if (file.exists("data/merged_topic_fit_7_classtpx_omega_fix_bmMSC1_earlyChond.rda")){
     Topic_clus_7_bmMSC1_earlyChond <- get(load(file="data/merged_topic_fit_7_classtpx_omega_fix_bmMSC1_earlyChond.rda"))
} else {
Topic_clus_7_bmMSC1_earlyChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=7,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_7_bmMSC1_earlyChond, file="data/merged_topic_fit_7_classtpx_omega_fix_bmMSC1_earlyChond.rda")
}

omega <- Topic_clus_7_bmMSC1_earlyChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Perform topic modeling k=8
if (file.exists("data/merged_topic_fit_8_classtpx_omega_fix_bmMSC1_earlyChond.rda")){
     Topic_clus_8_bmMSC1_earlyChond <- get(load(file="data/merged_topic_fit_8_classtpx_omega_fix_bmMSC1_earlyChond.rda"))
} else {
Topic_clus_8_bmMSC1_earlyChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=8,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_8_bmMSC1_earlyChond, file="data/merged_topic_fit_8_classtpx_omega_fix_bmMSC1_earlyChond.rda")
}

omega <- Topic_clus_8_bmMSC1_earlyChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Perform topic modeling k=7
if (file.exists("data/merged_topic_fit_7_classtpx_omega_fix_bmMSC2_earlyChond.rda")){
     Topic_clus_7_bmMSC2_earlyChond <- get(load(file="data/merged_topic_fit_7_classtpx_omega_fix_bmMSC2_earlyChond.rda"))
} else {
Topic_clus_7_bmMSC2_earlyChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=7,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_7_bmMSC2_earlyChond, file="data/merged_topic_fit_7_classtpx_omega_fix_bmMSC2_earlyChond.rda")
}

omega <- Topic_clus_7_bmMSC2_earlyChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Perform topic modeling k=8
if (file.exists("data/merged_topic_fit_8_classtpx_omega_fix_bmMSC2_earlyChond.rda")){
     Topic_clus_8_bmMSC2_earlyChond <- get(load(file="data/merged_topic_fit_8_classtpx_omega_fix_bmMSC2_earlyChond.rda"))
} else {
Topic_clus_8_bmMSC2_earlyChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=8,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_8_bmMSC2_earlyChond, file="data/merged_topic_fit_8_classtpx_omega_fix_bmMSC2_earlyChond.rda")
}

omega <- Topic_clus_8_bmMSC2_earlyChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
omega <- Topic_clus_7_allMSC_lateChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
omega <- Topic_clus_8_allMSC_lateChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
omega <- Topic_clus_7_adMSC_lateChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
omega <- Topic_clus_8_adMSC_lateChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
omega <- Topic_clus_7_bmMSC1_lateChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
omega <- Topic_clus_8_bmMSC1_lateChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
omega <- Topic_clus_7_bmMSC2_lateChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
omega <- Topic_clus_8_bmMSC2_lateChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Semi-supervised topic modeling (DEFINE ENCODE chondros separately as a cluster)

```{r supervised with chond ENCODE}
#Here I define the chond cluster based on only early passage chond
# labels for "known" clusters
index_heart <- which(labels=="Heart")
index_lung <- which(labels=="Lung")
...
index_kidney <- which(labels=="Kidney")
index_iPSC <- which(labels=="iPSC")
index_chond <- chond_encode ######## for ENCODE
index_MSCs <- c(adMSC_index, bmMSC1_index, bmMSC2_index)
...
# Perform topic modeling k=7
if (file.exists("data/merged_topic_fit_7_classtpx_omega_fix_allMSC_ENCODEChond.rda")){
     Topic_clus_7_allMSC_ENCODEChond <- get(load(file="data/merged_topic_fit_7_classtpx_omega_fix_allMSC_ENCODEChond.rda"))
} else {
Topic_clus_7_allMSC_ENCODEChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=7,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_7_allMSC_ENCODEChond, file="data/merged_topic_fit_7_classtpx_omega_fix_allMSC_ENCODEChond.rda")
}

omega <- Topic_clus_7_allMSC_ENCODEChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Perform topic modeling k=8
if (file.exists("data/merged_topic_fit_8_classtpx_omega_fix_allMSC_ENCODEChond.rda")){
     Topic_clus_8_allMSC_ENCODEChond <- get(load(file="data/merged_topic_fit_8_classtpx_omega_fix_allMSC_ENCODEChond.rda"))
} else {
Topic_clus_8_allMSC_ENCODEChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=8,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_8_allMSC_ENCODEChond, file="data/merged_topic_fit_8_classtpx_omega_fix_allMSC_ENCODEChond.rda")
}

omega <- Topic_clus_8_allMSC_ENCODEChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Perform topic modeling k=7
if (file.exists("data/merged_topic_fit_7_classtpx_omega_fix_adMSC_ENCODEChond.rda")){
     Topic_clus_7_adMSC_ENCODEChond <- get(load(file="data/merged_topic_fit_7_classtpx_omega_fix_adMSC_ENCODEChond.rda"))
} else {
Topic_clus_7_adMSC_ENCODEChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=7,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_7_adMSC_ENCODEChond, file="data/merged_topic_fit_7_classtpx_omega_fix_adMSC_ENCODEChond.rda")
}

omega <- Topic_clus_7_adMSC_ENCODEChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Perform topic modeling k=8
if (file.exists("data/merged_topic_fit_8_classtpx_omega_fix_adMSC_ENCODEChond.rda")){
     Topic_clus_8_adMSC_ENCODEChond <- get(load(file="data/merged_topic_fit_8_classtpx_omega_fix_adMSC_ENCODEChond.rda"))
} else {
Topic_clus_8_adMSC_ENCODEChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=8,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_8_adMSC_ENCODEChond, file="data/merged_topic_fit_8_classtpx_omega_fix_adMSC_ENCODEChond.rda")
}

omega <- Topic_clus_8_adMSC_ENCODEChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Perform topic modeling k=7
if (file.exists("data/merged_topic_fit_7_classtpx_omega_fix_bmMSC1_ENCODEChond.rda")){
     Topic_clus_7_bmMSC1_ENCODEChond <- get(load(file="data/merged_topic_fit_7_classtpx_omega_fix_bmMSC1_ENCODEChond.rda"))
} else {
Topic_clus_7_bmMSC1_ENCODEChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=7,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_7_bmMSC1_ENCODEChond, file="data/merged_topic_fit_7_classtpx_omega_fix_bmMSC1_ENCODEChond.rda")
}

omega <- Topic_clus_7_bmMSC1_ENCODEChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Perform topic modeling k=8
if (file.exists("data/merged_topic_fit_8_classtpx_omega_fix_bmMSC1_ENCODEChond.rda")){
     Topic_clus_8_bmMSC1_ENCODEChond <- get(load(file="data/merged_topic_fit_8_classtpx_omega_fix_bmMSC1_ENCODEChond.rda"))
} else {
Topic_clus_8_bmMSC1_ENCODEChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=8,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_8_bmMSC1_ENCODEChond, file="data/merged_topic_fit_8_classtpx_omega_fix_bmMSC1_ENCODEChond.rda")
}

omega <- Topic_clus_8_bmMSC1_ENCODEChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Perform topic modeling k=7
if (file.exists("data/merged_topic_fit_7_classtpx_omega_fix_bmMSC2_ENCODEChond.rda")){
     Topic_clus_7_bmMSC2_ENCODEChond <- get(load(file="data/merged_topic_fit_7_classtpx_omega_fix_bmMSC2_ENCODEChond.rda"))
} else {
Topic_clus_7_bmMSC2_ENCODEChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=7,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_7_bmMSC2_ENCODEChond, file="data/merged_topic_fit_7_classtpx_omega_fix_bmMSC2_ENCODEChond.rda")
}

omega <- Topic_clus_7_bmMSC2_ENCODEChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
...
# Perform topic modeling k=8
if (file.exists("data/merged_topic_fit_8_classtpx_omega_fix_bmMSC2_ENCODEChond.rda")){
     Topic_clus_8_bmMSC2_ENCODEChond <- get(load(file="data/merged_topic_fit_8_classtpx_omega_fix_bmMSC2_ENCODEChond.rda"))
} else {
Topic_clus_8_bmMSC2_ENCODEChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=8,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_8_bmMSC2_ENCODEChond, file="data/merged_topic_fit_8_classtpx_omega_fix_bmMSC2_ENCODEChond.rda")
}

omega <- Topic_clus_8_bmMSC2_ENCODEChond$omega
annotation <- data.frame(
  sample_id = paste0("X", c(1:NROW(omega))),
  tissue_label = as.factor(labels))
rownames(omega) <- annotation$sample_id
