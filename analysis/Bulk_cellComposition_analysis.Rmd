...
names(outside_data_counts) <- c("OA_dmg_3", "MSC-Chond-d14_1", "MSC-Chond-d1_2", "Chond_TCP_P1_2", "MSC-Chond-d3_2",
                                "Lung_4", "Chond_TCP_P1_3", "Lung_3", "Chond_TCP_P1_1", "bmMSC_1.1", 
                                "MSC-Chond-d3_1", "Lung_2", "MSC-Chond-d0_1", "Heart_4", "MSC-Chond-d7_1",
                                "MSC-Chond-d21_3", "MSC-Chond-d3_3", "Heart_1", "iPSC-MSC5_2", "iPSC-MSC9_1",
                                "Kidney_1", "Heart_2", "iPSC-1", "iPSC-MSC5_1", "bmMSC_2.2", 
                                "bmMSC_1.2", "OA_dmg_2", "OA_intact_3", "Kidney_3", "Liver_1", 
                                "Chond_SCM_P1_3", "OA_intact_2", "Liver_3", "Liver_4", "OA_dmg_1", 
                                "Heart_3", "MSC-Chond-d14_3", "Chond_SCM_P1_1", "iPSC-2", "MSC-Chond-d21_2",
                                "bmMSC_1.3", "MSC-Chond-d1_1", "MSC-Chond-d0_2", "adMSC", "Kidney_2",
                                "MSC-Chond-d1_3", "Kidney_4", "Chond_SCM_P1_2", "MSC-Chond-d14_2", "MSC-Chond-d0_3",
                                "OA_intact_1", "Liver_2", "iPSC-MSC9_2", "MSC-Chond-d21_1", "Lung_1", 
                                "bmMSC_2.1", "MSC-Chond-d7_3", "MSC-Chond-d7_2")

#remove MSC-chond samples and OA samples
MSC_chond_samples <- c(2:3, 5, 11, 13, 15:17, 37, 40, 42:43, 46, 49:50, 54, 57:58)
OA_samples <- c(1, 27:28, 32, 35, 51)
...
# k = 9
#plot_structure_plot(omega = Combined_GoM$clust_9$omega, labels = labels)
make_topic_plots(omega = Combined_GoM$clust_9$omega, labels = labels)
genes <- annotate_clusters(theta_mat = Combined_GoM$clust_9$theta, countmatrix = merged_raw_data_counts)
matrix(gene_anno$external_gene_name[match(genes[[1]], gene_anno$ensembl_gene_id)], ncol = 100)
genes[[2]]
```
...
Topic_clus <- classtpx::class_topics(
    ...
    method="omega.fix",
    tol=0.01)
save(Topic_clus, file="data/merged_topic_fit_6_classtpx_omega_fix.rda")
Topic_clus <- get(load(file="data/merged_topic_fit_6_classtpx_omega_fix.rda"))
...
Topic_clus <- classtpx::class_topics(
    ...
    method="omega.fix",
    tol=0.01)
save(Topic_clus, file="data/merged_topic_fit_7_classtpx_omega_fix.rda")
Topic_clus <- get(load(file="data/merged_topic_fit_7_classtpx_omega_fix.rda"))
