...
if (file.exists("data/merged_topic_fit_7_classtpx_omega_fix_allMSC_lateChond.rda")){
     Topic_clus_7_allMSC_lateChond <- get(load(file="data/merged_topic_fit_7_classtpx_omega_fix_allMSC_lateChond.rda"))
} else {
Topic_clus_7_allMSC_lateChond <- classtpx::class_topics(
    ...
    method="omega.fix",
    tol=0.01)
save(Topic_clus_7_allMSC_lateChond, file="data/merged_topic_fit_7_classtpx_omega_fix_allMSC_lateChond.rda")
}

# Perform topic modeling k=8
if (file.exists("data/merged_topic_fit_8_classtpx_omega_fix_allMSC_lateChond.rda")){
     Topic_clus_8_allMSC_lateChond <- get(load(file="data/merged_topic_fit_8_classtpx_omega_fix_allMSC_lateChond.rda"))
} else {
Topic_clus_8_allMSC_lateChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=8,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_8_allMSC_lateChond, file="data/merged_topic_fit_8_classtpx_omega_fix_allMSC_lateChond.rda")
}

#Here I define a MSC cluster based on adMSCs
# labels for "known" clusters
index_MSCs <- adMSC_index
...
# Perform topic modeling k=7
if (file.exists("data/merged_topic_fit_7_classtpx_omega_fix_adMSC_lateChond.rda")){
     Topic_clus_7_adMSC_lateChond <- get(load(file="data/merged_topic_fit_7_classtpx_omega_fix_adMSC_lateChond.rda"))
} else {
Topic_clus_7_adMSC_lateChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=7,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_7_adMSC_lateChond, file="data/merged_topic_fit_7_classtpx_omega_fix_adMSC_lateChond.rda")
}

# Perform topic modeling k=8
if (file.exists("data/merged_topic_fit_8_classtpx_omega_fix_adMSC_lateChond.rda")){
     Topic_clus_8_adMSC_lateChond <- get(load(file="data/merged_topic_fit_8_classtpx_omega_fix_adMSC_lateChond.rda"))
} else {
Topic_clus_8_adMSC_lateChond <- classtpx::class_topics(
    t(merged_raw_data_counts),
    K=8,
    known_samples = known_samples,
    class_labs = class_labs,
    method="omega.fix",
    tol=0.01)
save(Topic_clus_8_adMSC_lateChond, file="data/merged_topic_fit_8_classtpx_omega_fix_adMSC_lateChond.rda")
}
